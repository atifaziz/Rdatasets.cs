...
namespace Rdatasets.DAAG
{
    ...
    public class cuckoohosts
    {
        ...
        public readonly string hlength;
        public readonly string hl_sd;
        public readonly string hbreadth;
        public readonly string hb_sd;
        public readonly string hnum;
        public readonly int match;
        public readonly int nomatch;

        public cuckoohosts(double clength, double cl_sd, double cbreadth, double cb_sd, int cnum, string hlength, string hl_sd, string hbreadth, string hb_sd, string hnum, int match, int nomatch)
        {
