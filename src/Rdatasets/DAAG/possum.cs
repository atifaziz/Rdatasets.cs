...
namespace Rdatasets.DAAG
{
    ...
    public class possum
    {
        ...
        public possum(int @case, int site, string Pop, string sex, int? age, double hdlngth, double skullw, double totlngth, double taill, double? footlgth, double earconch, double eye, double chest, double belly)
        {
            this.@case = @case;
            this.site = site;
            this.Pop = Pop;
