...
namespace Rdatasets.DAAG
{
    ...
    public class socsupport
    {
        ...
        public readonly string emotionalsat;
        public readonly string tangible;
        public readonly string tangiblesat;
        public readonly int affect;
        public readonly int affectsat;
        public readonly int psi;
        public readonly int psisat;
        public readonly string esupport;
        public readonly string psupport;
        public readonly string supsources;
        public readonly int BDI;

        public socsupport(string gender, string age, string country, string marital, string livewith, string employment, string firstyr, string enrolment, int emotional, string emotionalsat, string tangible, string tangiblesat, int affect, int affectsat, int psi, int psisat, string esupport, string psupport, string supsources, int BDI)
        {
            this.gender = gender;
            this.age = age;
