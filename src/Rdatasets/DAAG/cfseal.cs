...
namespace Rdatasets.DAAG
{
    ...
    public class cfseal
    {
        ...
        public readonly string lung;
        public readonly double liver;
        public readonly string spleen;
        public readonly double stomach;
        public readonly string leftkid;
        public readonly string rightkid;
        public readonly int kidney;
        public readonly string intestines;

        public cfseal(int age, double weight, double heart, string lung, double liver, string spleen, double stomach, string leftkid, string rightkid, int kidney, string intestines)
        {
            this.age = age;
            this.weight = weight;
            this.heart = heart;
