...
namespace Rdatasets.mi
{
    ...
    public class nlsyV
    {
        public readonly string ppvtr_36;
        public readonly int first;
        public readonly string b_marr;
        public readonly string income;
        public readonly int momage;
        public readonly string momed;
        public readonly string momrace;

        public nlsyV(string ppvtr_36, int first, string b_marr, string income, int momage, string momed, string momrace)
        {
