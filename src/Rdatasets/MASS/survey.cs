...
namespace Rdatasets.MASS
{
    ...
    public class survey
    {
        ...
        public readonly string Wr_Hnd;
        public readonly string NW_Hnd;
        ...
        public survey(string Sex, string Wr_Hnd, string NW_Hnd, string W_Hnd, string Fold, string Pulse, string Clap, string Exer, string Smoke, string Height, string M_I, double Age)
        {
            this.Sex = Sex;
            this.Wr_Hnd = Wr_Hnd;
            this.NW_Hnd = NW_Hnd;
