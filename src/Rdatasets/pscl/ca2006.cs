...
namespace Rdatasets.pscl
{
    ...
    public class ca2006
    {
        ...
        public ca2006(int district, int? D, int? R, int? Other, string IncParty, string IncName, bool open, bool contested, int Bush2004, int Kerry2004, int Other2004, int Bush2000, int Gore2000)
        {
