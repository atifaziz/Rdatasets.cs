...
namespace Rdatasets.sandwich
{
    ...
    public class Investment
    {
        ...
        public readonly string RealInt;

        public Investment(double GNP, double Investment_, double Price, double Interest, double RealGNP, double RealInv, string RealInt)
        {
            this.GNP = GNP;
