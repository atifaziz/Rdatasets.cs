...
namespace Rdatasets.ggplot2
{
    ...
    public class msleep
    {
        ...
        public readonly string sleep_rem;
        public readonly string sleep_cycle;
        public readonly double awake;
        public readonly string brainwt;
        public readonly double bodywt;

        public msleep(string name, string genus, string vore, string order, string conservation, double sleep_total, string sleep_rem, string sleep_cycle, double awake, string brainwt, double bodywt)
        {
            this.name = name;
            this.genus = genus;
            this.vore = vore;
