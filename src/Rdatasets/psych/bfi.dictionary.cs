...
namespace Rdatasets.psych
{
    ...
    public class bfi_dictionary
    {
        ...
        public readonly string Keying;
        public readonly string IPIP100;

        public bfi_dictionary(string ItemLabel, string Item, string Giant3, string Big6, string Little12, string Keying, string IPIP100)
        {
