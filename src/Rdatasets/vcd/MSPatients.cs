...
namespace Rdatasets.vcd
{
    ...
    public class MSPatients
    {
        ...
        public MSPatients(int Certain_Winnipeg, int Probable_Winnipeg, int Possible_Winnipeg, int Doubtful_Winnipeg, int Certain_New_Orleans, int Probable_New_Orleans, int Possible_New_Orleans, int Doubtful_New_Orleans)
        {
        ...
        public static IEnumerable<MSPatients> Data
        {
            get
            {
                yield return new MSPatients(38, 5, 0, 1, 5, 3, 0, 0);
                yield return new MSPatients(33, 11, 3, 0, 3, 11, 4, 0);
                yield return new MSPatients(10, 14, 5, 6, 2, 13, 3, 4);
                yield return new MSPatients(3, 7, 3, 10, 1, 2, 4, 14);
            }
        }
    }
}
