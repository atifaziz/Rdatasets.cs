...
namespace Rdatasets.Ecdat
{
    ...
    public class USFinanceIndustry
    {
        ...
        public readonly string CorporateProfitsAdj;
        public readonly string Domestic;
        public readonly string Financial;
        public readonly string Nonfinancial;
        public readonly string restOfWorld;
        public readonly string FinanceProportion;

        public USFinanceIndustry(int year, string CorporateProfitsAdj, string Domestic, string Financial, string Nonfinancial, string restOfWorld, string FinanceProportion)
        {
            this.year = year;
        ...
        public static IEnumerable<USFinanceIndustry> Data
        {
            get
            {
                ...
                yield return new USFinanceIndustry(1987, "367.8", "319.8", "59.9", "259.9", "48", "0.187304565353346");
