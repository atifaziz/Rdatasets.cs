...
namespace Rdatasets.Ecdat
{
    ...
    public class USFinanceIndustry
    {
        ...
        public USFinanceIndustry(int year, double? CorporateProfitsAdj, double? Domestic, double? Financial, double? Nonfinancial, double? restOfWorld, double? FinanceProportion)
        {
            this.year = year;
