...
namespace Rdatasets.Ecdat
{
    ...
    public class UStaxWords
    {
        ...
        public UStaxWords(int year, int? IncomeTaxCode, int? otherTaxCode, int? EntireTaxCode, int? IncomeTaxRegulations, int? otherTaxRegulations, int? EntireTaxRegulations, int? IncomeTaxCodeAndRegs, int? otherTaxCodeAndRegs, int EntireTaxCodeAndRegs)
        {
            this.year = year;
