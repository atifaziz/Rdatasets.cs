...
namespace Rdatasets.Ecdat
{
    ...
    public class politicalKnowledge
    {
        ...
        public politicalKnowledge(string country, double DomesticKnowledge_hs, double DomesticKnowledge_sc, double DomesticKnowledge_c, double InternationalKnowledge_hs, double InternationalKnowledge_sc, double InternationalKnowledge_c, double PoliticalKnowledge_hs, double PoliticalKnowledge_sc, double PoliticalKnowledge_c, double PublicMediaPerCapita, double PublicMediaRel2US)
        {
        ...
        public static IEnumerable<politicalKnowledge> Data
        {
            get
            {
                yield return new politicalKnowledge("Denmark", 0.77, 0.79, 0.77, 0.65, 0.67, 0.65, 0.71, 0.73, 0.71, 101, 74.81);
                yield return new politicalKnowledge("Finland", 0.74, 0.75, 0.85, 0.56, 0.69, 0.7, 0.65, 0.72, 0.775, 101, 74.81);
                yield return new politicalKnowledge("UK", 0.62, 0.65, 0.72, 0.52, 0.54, 0.68, 0.57, 0.595, 0.7, 80, 59.26);
                yield return new politicalKnowledge("US", 0.4, 0.61, 0.77, 0.22, 0.42, 0.65, 0.31, 0.515, 0.71, 1.35, 1);
            }
        }
    }
}
