...
namespace Rdatasets.Stat2Data
{
    ...
    public class BirdNest
    {
        ...
        public readonly string Incubate;
        public readonly double Nestling;
        public readonly string Totcare;
        public readonly int Closed_;

        public BirdNest(string Species, string Common, int Page, double Length, string Nesttype, string Location, double No_eggs, int Color, string Incubate, double Nestling, string Totcare, int Closed_)
        {
