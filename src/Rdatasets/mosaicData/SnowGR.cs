...
namespace Rdatasets.mosaicData
{
    ...
    public class SnowGR
    {
        ...
        public SnowGR(int SeasonStart, int SeasonEnd, int Jul, int Aug, int Sep, double Oct, double Nov, double Dec, double? Jan, double? Feb, double? Mar, double? Apr, double? May, int? Jun, double? Total)
        {
