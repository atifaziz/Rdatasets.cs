...
+-----------------------------------+-----------------------------------+
| Demand:                           | Total electricity demand in GW    |
|                                   | for Victoria, Australia, every    |
|                                   | half-hour during 2014.            |
+-----------------------------------+-----------------------------------+
| WorkDay:                          | taking value 1 on work days, and  |
|                                   | 0 otherwise.                      |
+-----------------------------------+-----------------------------------+
| Temperature:                      | half-hourly temperatures for      |
|                                   | Melbourne (BOM site 086071).      |
+-----------------------------------+-----------------------------------+
...
|                                   | 0 otherwise.                      |
+-----------------------------------+-----------------------------------+
| Temperature:                      | maximum daily temperatures for    |
|                                   | Melbourne (BOM site 086071).      |
+-----------------------------------+-----------------------------------+
